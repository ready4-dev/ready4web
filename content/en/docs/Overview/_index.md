...
## Why is that useful?
We hope that ready4 will help [address significant limitations](/docs/getting-started/motivation/) in how health economic models are implemented, encourage [data sharing](/docs/model/datasets) and facilitate [modelling analyses](/docs/model/analyses) that [generate valuable insights](/docs/examples) for health policymakers and system planners.
...
Currently, ready4 is being applied to develop and apply [a modular model of youth mental health](https://readyforwhatsnext.com/).
